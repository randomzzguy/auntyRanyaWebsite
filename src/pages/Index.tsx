        ...
        <header className="fixed top-0 inset-x-0 z-50 border-b-2 border-ink bg-paper/90 backdrop-blur">
          <div className="container flex items-center justify-between py-3">
            <a href="#home" className="flex items-center gap-2 font-display text-xl font-extrabold">
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-secondary border-2 border-ink brutal-sm overflow-hidden">
        ...
        <div className="container grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <a href="https://www.facebook.com/ranya.ibrahimahmed" target="_blank" rel="noopener noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-paper/10 border border-paper/20 hover:bg-accent hover:border-accent transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/aroaajm.educational.games/" target="_blank" rel="noopener noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-paper/10 border border-paper/20 hover:bg-accent hover:border-accent transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@mrs.alphabetstories?_r=1&_t=ZS-963woSchzCj" target="_blank" rel="noopener noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-paper/10 border border-paper/20 hover:bg-accent hover:border-accent transition-colors" aria-label="TikTok">
